<template>
  <div>
    ...
    <div v-if="isActive" id="modal">
      ...
      <img :src="selectedBook.cover" alt="selected.cover" class="selected-book-modal">
...
const getTotalPage = computed(() => {
  return Math.ceil(BookStore.bestseller.length / perPage)
})
